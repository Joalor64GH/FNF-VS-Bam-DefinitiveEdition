...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['You Stupid', 0.2], //From 0% to 19%
		['Why are we still here?', 0.4], //From 20% to 39%
		['Try again', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['DaMn DaNiEl', 0.69], //From 60% to 68%
		['69 funni number', 0.7], //69%
		['Okay ig', 0.8], //From 70% to 79%
		['AEUGH', 0.9], //From 80% to 89%
		['It is...acceptable.', 1], //From 90% to 99%
		['POGRZ!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
